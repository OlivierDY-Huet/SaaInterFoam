...
)
{
...

    {
		...
		/*
		Info<< " " <<endl;
		Info<< "splitFaces:  "<<endl;
		Info<< splitFaces.toc() <<endl;
		Info<< " " <<endl;
		*/
    }
    ...
    forAll(splitEdgeLabels, i)
    {
        ...
        //if (debug)
        {
			...
			forAll(eCells, j)
            {
				...
				Info<< "Cell info: celli = " << celli << " ; Region = " << region << " ; Region master = " << cellRegionMaster[region] <<endl;
			}
			*/
            ...
            forAll(eCells, j)
            {
                ...
                if (masterCelli != cellRegionMaster[region])
                {
					...
					forAll(splitEdgeLabels, iPrint)
					{
						const labelList& eFaces = mesh_.edgeFaces()[splitEdgeLabels[iPrint]];
